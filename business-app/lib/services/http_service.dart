...
class HttpService {
  ...
  Future<Response> _postWithHeader(
    ...
    try {
      ...
      res = await _dio.request(_baseUrl + path,
          ...
          queryParameters: query,
          options:
              Options(method: 'POST', headers: {'x-access-token': header}));
      return res;
    } on SocketException {
      showToast('No Internet Connection');
      throw Exception('No Internet connection');
  ...
  Future<Response> _putWithHeader(
    ...
    try {
      ...
      res = await _dio.request(_baseUrl + path,
          data: body,
          queryParameters: query,
          options: Options(method: 'PUT', headers: {'x-access-token': header}));
      return res;
    } on SocketException {
      showToast('No Internet Connection');
      throw Exception('No Internet connection');
  ...
  Future<Response> _deleteWithHeader(
    ...
    try {
      ...
      res = await _dio.request(_baseUrl + path,
          ...
          queryParameters: query,
          options:
              Options(method: 'DELETE', headers: {'x-access-token': header}));
      return res;
    } on SocketException {
      showToast('No Internet Connection');
      throw Exception('No Internet connection');
  ...
  Future<Response> _getWithHeader(
    ...
    try {
      ...
      res = await _dio.request(_baseUrl + path,
          queryParameters: query,
          options: Options(method: 'GET', headers: {'x-access-token': header}));
      return res;
    } on SocketException {
      showToast('No Internet Connection');
      throw Exception('No Internet connection');
